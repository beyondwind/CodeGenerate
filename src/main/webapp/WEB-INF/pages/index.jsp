	...
	<div class="site-wrapper-inner">
		...
		<div class="cover-container">
			...
			<div class="inner cover">
				...
				<p class="lead">
					<a href="step1.html" class="btn btn-lg btn-default">Let's Begin&nbsp;
			...
			<div class="mastfoot">
				<div class="inner">
					<p>Code Generator for <a href="http://www.bizpartner.cn/">Â© Bizpartner</a>, by <a href="https://github.com/beyondwind">@ç´«è±</a>.</p>
				</div>
			</div>
		</div>
  </div>
